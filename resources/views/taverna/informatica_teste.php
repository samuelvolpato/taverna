...
<body>
    <?php include_once('utils\produtosTeste.php'); ?>
    ...
    <main class="container-fluid">
        ...
        <section class="container my-3 p-0">
            ...
            <div class="row m-0 px-0 py-2" style="width: 100%">
                ...
                <?php foreach ($produtosTeste as $nomeTeste => $infosTeste) { ?>
                  <?php if ($infosTeste[3] == "informatica") {     ?>
                    <div class="col-lg-3 col-sm-6 m-0 p-3">
                        <img src="<?php echo $infosTeste[0]; ?>"  class=" card-img-top img-games" alt="<?php echo $infosTeste[1]; ?>" width="500" heigth="500">
                        <div class="row justify-content-center mt-2 px-2">
                            <h5 class=" text-white"><?php echo $infosTeste[1]; ?></h5>
                        </div>
                        ...
                        <div class="row p-0 mt-2 justify-content-around">
                            <p class="text-white"><strong><?php echo $infosTeste[3]; ?> ofertas a partir de</strong></p>
                        </div>
                        <div class="row justify-content-center">
                            <h2 class="text-white text-center">R$ <?php echo $infosTeste[2]; ?></h2>
                        </div>
